...
//            Route::get('food', 'FoodController@index', ['id', 'name']);
            Route::get('admin/index', 'FoodController@index');
            Route::get('admin/foods', 'FoodController@foods');
            Route::get('admin/users', 'FoodController@users');
            Route::get('admin/login', 'FoodController@login');
...
//            Route::get('food/foods');
//            Route::get('admin/login', 'FoodController@login');
//            Route::get('admin/users', 'FoodController@users');
//            Route::post('/', 'MainController@index', ['text']);
